...
require_once($game_root_path.'/includes/TagParser.php');
...
$this->addSmiley(':huh:', 'images/smiles/icon_neutral.gif');
$this->addSmiley(':)', 'images/smiles/icon_smile.gif');
$this->addSmiley(':-)', 'images/smiles/icon_smile.gif');
$this->addSmiley('=)', 'images/smiles/icon_smile.gif');
$this->addSmiley(':P', 'images/smiles/icon_razz.gif');
$this->addSmiley('=P', 'images/smiles/icon_razz.gif');
$this->addSmiley(':-P', 'images/smiles/icon_razz.gif');
$this->addSmiley(':D', 'images/smiles/icon_biggrin.gif');
$this->addSmiley(':-D', 'images/smiles/icon_biggrin.gif');
$this->addSmiley('=D', 'images/smiles/icon_biggrin.gif');
$this->addSmiley('XD', 'images/smiles/icon_biggrin.gif');
$this->addSmiley(':o', 'images/smiles/icon_surprised.gif');
$this->addSmiley(':0', 'images/smiles/icon_surprised.gif');
$this->addSmiley('B)', 'images/smiles/icon_cool.gif');
$this->addSmiley('B-)', 'images/smiles/icon_cool.gif');
$this->addSmiley('8-)', 'images/smiles/icon_cool.gif');
$this->addSmiley('8)', 'images/smiles/icon_cool.gif');
$this->addSmiley('wink', 'images/smiles/icon_wink.gif');
$this->addSmiley(';)', 'images/smiles/icon_wink.gif');
$this->addSmiley(';-)', 'images/smiles/icon_wink.gif');
$this->addSmiley(':lol:', 'images/smiles/icon_lol.gif');
$this->addSmiley(':blink:', 'images/smiles/icon_eek.gif');
$this->addSmiley(':(', 'images/smiles/icon_sad.gif');
$this->addSmiley(':-(', 'images/smiles/icon_sad.gif');
$this->addSmiley('=(', 'images/smiles/icon_sad.gif');
$this->addSmiley(':rolleyes:', 'images/smiles/icon_rolleyes.gif');
$this->addSmiley(':roll:', 'images/smiles/icon_rolleyes.gif');
$this->addSmiley(':unsure:', 'images/smiles/icon_frown.gif');
$this->addSmiley(':angry:', 'images/smiles/icon_mad.gif');
$this->addSmiley(':x', 'images/smiles/icon_mad.gif');
$this->addSmiley('^^', 'images/smiles/icon_biggrin.gif');
$this->addSmiley('^.^', 'images/smiles/icon_biggrin.gif');
$this->addSmiley('^_^', 'images/smiles/icon_biggrin.gif');
$this->addSmiley(':idea:', 'images/smiles/icon_idea.gif');
$this->addSmiley(':mrgreen:', 'images/smiles/icon_mrgreen.gif');
$this->addSmiley(':?:', 'images/smiles/icon_question.gif');
$this->addSmiley(':!:', 'images/smiles/icon_exclaim.gif');
$this->addSmiley(':arrow:', 'images/smiles/icon_arrow.gif');
$this->addSmiley(':cry:', 'images/smiles/icon_cry.gif');
...
$this->PARSE_ENABLE_FIX_URLS	    = 'url';
	...
	*/
	...
	{
		//echo "IMAGESIZE!!<br />\n";
		require_once($game_root_path.'/lib/imagesize.php');
