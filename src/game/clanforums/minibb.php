...
include ($game_root_path.'/clanforums/setup_options.php');
...
if (isset($_POST['mode']) and $_POST['mode']=='login') require_once($game_root_path.'/clanforums/bb_func_login.php');
...
user_logged_in();
if($user_id!=0 and isset($langu) and $langu=str_replace(array('.','/','\\'),'',$langu) and file_exists($game_root_path."/clanforums/lang/{$langu}.php")) $lang=$langu;
elseif($user_id==0 and isset($_GET['setlang']) and $setlang=str_replace(array('.','/','\\'),'',$_GET['setlang']) and file_exists($game_root_path."/clanforums/lang/{$_GET['setlang']}.php")) {$lang=$setlang; $indexphp.='setlang='.$setlang.'&';}
...
if ($logged_admin==1) {
$l_adminpanel_link='<a href="'.$bb_admin.'">'.$l_adminpanel.'</small></a><br />';
}
...
if($action=='pthread') {if($reqTxt!=1)require_once($game_root_path.'/clanforums/bb_func_txt.php');require_once($game_root_path.'/clanforums/bb_func_pthread.php');}
elseif($action=='ptopic') {if($reqTxt!=1)require_once($game_root_path.'/clanforums/bb_func_txt.php');require_once($game_root_path.'/clanforums/bb_func_ptopic.php');}
...
elseif($action=='vthread') require_once($game_root_path.'/clanforums/bb_func_vthread.php');
...
else require_once($game_root_path.'/clanforums/bb_func_vtopic.php');
}
...
elseif($action=='search') {if($reqTxt!=1)require_once($game_root_path.'/clanforums/bb_func_txt.php');require_once($game_root_path.'/clanforums/bb_func_search.php');}

elseif($action=='deltopic') require_once($game_root_path.'/clanforums/bb_func_deltopic.php');

elseif($action=='locktopic') require_once($game_root_path.'/clanforums/bb_func_locktop.php');

elseif($action=='editmsg') {$step=0;require_once($game_root_path.'/clanforums/bb_func_editmsg.php');}

elseif($action=='editmsg2') {require_once($game_root_path.'/clanforums/bb_func_txt.php');$step=1;require_once($game_root_path.'/clanforums/bb_func_editmsg.php');}

elseif($action=='delmsg') {$step=0;require_once($game_root_path.'/clanforums/bb_func_delmsg.php');}

elseif($action=='movetopic') {$step=0;require_once($game_root_path.'/clanforums/bb_func_movetpc.php');}

elseif($action=='movetopic2') {$step=1;require_once($game_root_path.'/clanforums/bb_func_movetpc.php');}

elseif($action=='userinfo') require_once($game_root_path.'/clanforums/bb_func_usernfo.php');

elseif($action=='sendpass') {$step=0;require_once($game_root_path.'/clanforums/bb_func_sendpwd.php');}

elseif($action=='sendpass2') {$step=1;require_once($game_root_path.'/clanforums/bb_func_sendpwd.php');}

elseif($action=='confirmpasswd') {if (!isset($confirmCode)) $confirmCode=''; require_once($game_root_path.'/clanforums/bb_func_confpwd.php');}

elseif($action=='stats') require_once($game_root_path.'/clanforums/bb_func_stats.php');

elseif($action=='manual') require_once($game_root_path.'/clanforums/bb_func_man.php');

elseif($action=='registernew' and $enableNewRegistrations) {$step=0;require_once($game_root_path.'/clanforums/bb_func_regusr.php');}

elseif($action=='register' and $enableNewRegistrations) {$step=1;require_once($game_root_path.'/clanforums/bb_func_regusr.php');}

elseif($action=='prefs' and $enableProfileUpdate) {$step=0;require_once($game_root_path.'/clanforums/bb_func_editprf.php');}

elseif($action=='editprefs' and $enableProfileUpdate) {$step=1;require_once($game_root_path.'/clanforums/bb_func_editprf.php');}

elseif($action=='unsubscribe') require_once($game_root_path.'/clanforums/bb_func_unsub.php');

elseif($action=='sticky') {$status=9;require_once($game_root_path.'/clanforums/bb_func_sticky.php');}

elseif($action=='unsticky') {$status=0;require_once($game_root_path.'/clanforums/bb_func_sticky.php');}

elseif($action=='viewipuser') {require_once($game_root_path.'/clanforums/bb_func_viewip.php');}

elseif($action=='poll') {require_once($game_root_path.'/clanforums/hack_poll.php');}

elseif($action=='tpl') {
if (isset($tplName) and $tplName!='' and file_exists ($game_root_path.'/clanforums/templates/'.$tplName.'.html')){
echo load_header();
if(file_exists('local/game/clanforums/templates/'.$tplName.'.html'))
...
require_once($game_root_path.'/clanforums/bb_func_vforum.php');
if ($viewlastdiscussions!=0) {
require_once($game_root_path.'/clanforums/bb_func_ldisc.php');
