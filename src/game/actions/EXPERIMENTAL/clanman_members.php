...
function playeropts()
{
	global $uclan, $playerdb, $users, $authstr, $uera, $config;
?>
...
?>
<tr><td class="acenter">
<div class="radio <?if ($listclan[num] == $uclan[founder]) print " selected";?>"> 
  <input type="radio" name="modify_empire" value="<?=$listclan[num]?><?if ($listclan[num] == $uclan[founder]) print " CHECKED";?>">
</div></td>
    <td class="acenter"><a class=proflink href=?profiles&num=<?=$listclan[num]?><?=$authstr?>><?=$listclan[empire]?></a></td>
...
<tr><td style="text-align:right" colspan=5><?
	...
	{
?>
    <input type="submit" class="mainoption" name="do_makefounder" value="Leader"><br />
    <input type="submit" class="mainoption" name="do_remasst" value="Demote Assistant"><input class="mainoption" type="submit" name="do_makeasst" value="Make Assistant"><br />
<?
	}
?>
    <input type="submit" class="mainoption" name="do_remfa1" value="Demote Diplomat I"><input class="mainoption" type="submit" name="do_makefa1" value="Make Diplomat I"><br />
    <input type="submit" class="mainoption" name="do_remfa2" value="Demote Diplomat II"><input class="mainoption" type="submit" name="do_makefa2" value="Make Diplomat II"><br />
    <input type="submit" class="mainoption" name="do_removeempire" value="Remove"></td></tr>
</table><br />
<?
}
...
?>
<span style="font-size: 10px"><a href="?clanmanage<?=$authstr?>">News</a> | <b>Members</b> | <a href="?clanman_relations<?=$authstr?>">Relations</a> | <a href="?clanman_info<?=$authstr?>">Clan Info</a></span><br />
<br />
...
<?
if($uclan[open])
	echo '<input type="submit" class="mainoption" name="do_clanopen" value="Make Clan Closed">';
else
	echo '<input type="submit" class="mainoption" name="do_clanopen" value="Make Clan Open">';
?>
</form>
<form method="post" action="?clanman_members<?=$authstr?>">
<br /><br />
