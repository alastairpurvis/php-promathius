...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" align="center">
	<tr> 
	  <td align="left" valign="bottom" colspan="2"><a class="maintitle" href="{U_VIEW_FORUM}">{FORUM_NAME}</a><br /><span class="gensmall"><b>{L_MODERATOR}: {MODERATORS}</b></span></td>
...
<tr> 
	...
	<td class="row1" width="100%"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_TYPE}<script language="JavaScript">FolderStart('{topicrow.TOPIC_FOLDER_IMG}');</script><a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a><script language="JavaScript">FolderEnd();</script></span><span class="gensmall">
...
{End_Shadow}
  <table width="100%" cellspacing="2" align="center" cellpadding="2">
	<tr> 
	  ...
	  <td align="right" valign="middle" nowrap="nowrap"><span class="nav">{PAGE_NUMBER}</span><br /><span class="nav">{PAGINATION}</span> 
		</td>
	</tr>
	<tr>
	  <td align="left" colspan="3"><span class="gensmall">{LOGGED_IN_USER_LIST}</span></td>
	</tr>
  </table>
</form>
