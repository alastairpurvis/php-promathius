...
$activation_none = ( $new['require_once_activation'] == USER_ACTIVATION_NONE ) ? "checked=\"checked\"" : "";
$activation_user = ( $new['require_once_activation'] == USER_ACTIVATION_SELF ) ? "checked=\"checked\"" : "";
$activation_admin = ( $new['require_once_activation'] == USER_ACTIVATION_ADMIN ) ? "checked=\"checked\"" : "";
