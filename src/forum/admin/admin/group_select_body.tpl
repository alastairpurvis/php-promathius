...
<form method="post" action="{S_GROUP_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		
	<th class="forum" class="thHead" align="center">{L_GROUP_SELECT}</th>
	</tr>
	<!-- BEGIN select_box -->
	<tr>
