...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" align="center" class="forumline">
	<tr>
	  <th class="forum" class="thHead" colspan="2">{L_GENERAL_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
		<th class="forum" class="thHead" colspan="2">{L_COOKIE_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
		<th class="forum" class="thHead" colspan="2">{L_PRIVATE_MESSAGING}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="forum" class="thHead" colspan="2">{L_ABILITIES_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="forum" class="thHead" colspan="2">{L_AVATAR_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="forum" class="thHead" colspan="2">{L_COPPA_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="forum" class="thHead" colspan="2">{L_EMAIL_SETTINGS}</th>
	</tr>
	<tr>
