...
<tbody>
	...
	<tr> 
	  <th class="forum" class="thLeft" nowrap="nowrap">{L_AUTHOR}</th>
	  <th class="forum" nowrap="nowrap">{L_MESSAGE}</th>
	  <th class="forum" class="thRight" nowrap="nowrap">{L_SELECT}</th>
	</tr>
	<!-- BEGIN postrow -->
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3">
		  <tr> 
			<td valign="middle"><img src="../data/images/forums/post_old.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
	...
	<tr> 
	  <td colspan="3" height="1" class="row3"><img src="../data/images/forums/spacer.gif" width="1" height="1" alt="."></td>
	</tr>
	<!-- END postrow -->
	<tr> 
