...
<tr>
	<td width="19" height="19" class="quote-corner"><img src="../data/images/forums/quote_header.gif" width="19" height="19" alt="" /></td>
	<td width="100%" align="left" class="quote-header">{USERNAME} {L_WROTE}:</td>
</tr>
<tr>
	<td class="quote-left"><img src="../data/images/forums/spacer.gif" width="19" height="45" alt="" /></td>
...
<!-- BEGIN code_open --><center><table width="90%" cellspacing="0" cellpadding="0" align="center" class="code-table">
<tr>
	<td width="19" height="19" class="code-corner"><img src="../data/images/forums/code_header.gif" width="19" height="19" alt="" /></td>
	<td width="100%" align="left" class="code-header">{L_CODE}:</td>
</tr>
<tr>
	<td class="code-left"><img src="../data/images/forums/spacer.gif" width="19" height="40" alt="" /></td>
	<td class="code-text"><!-- END code_open -->
<!-- BEGIN code_close --></td>
	</tr>
</table></center>
<!-- END code_close -->
