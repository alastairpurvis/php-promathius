...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" class="forumline" align="center">
	<tr>
		<th class="forum" class="thHead" colspan="7">{L_FORUM_TITLE}</th>
	</tr>
	<!-- BEGIN catrow -->
	<tr>
	...
	<tr>
		<td colspan="7" height="1" class="spaceRow"><img src="../templates/cs/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END catrow -->
	<tr>
