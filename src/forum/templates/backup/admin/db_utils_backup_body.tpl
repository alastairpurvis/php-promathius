...
<form method="post" action="{S_DBUTILS_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		<th class="forum" colspan="2" class="thHead">{L_BACKUP_OPTIONS}</th>
	</tr>
	<tr>
