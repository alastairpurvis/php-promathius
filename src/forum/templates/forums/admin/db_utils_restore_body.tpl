...
<form enctype="multipart/form-data" method="post" action="{S_DBUTILS_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		<th class="forum" class="thHead">{L_SELECT_FILE}</th>
	</tr>
	<tr>
