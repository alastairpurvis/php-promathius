...
<form action="{S_GROUP_ACTION}" method="post" name="post"><table cellpadding="3" cellspacing="1" class="forumline" align="center">
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_GROUP_EDIT_DELETE}</th>
	</tr>
	<tr>
