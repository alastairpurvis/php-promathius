...
<form method="post" action="{S_SMILEY_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		<th class="forum" class="thCornerL">{L_CODE}</th>
		<th class="forum" class="thTop">{L_SMILE}</th>
		<th class="forum" class="thTop">{L_EMOT}</th>
		<th class="forum" colspan="2" class="thCornerR">{L_ACTION}</th>
	</tr>
	<!-- BEGIN smiles -->
	<tr>
