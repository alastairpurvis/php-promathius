...
$lang['Welcome_phpBB'] = 'Welcome to Forum Administration';
$lang['Admin_intro'] = 'This screen will give you a quick overview of all the various statistics of your board. You can get back to this page by clicking on the <u>Admin Index</u> link in the left pane. The other links on the left hand side of this screen will allow you to control every aspect of your forum experience. Each screen will have instructions on how to use the tools.';
...
$lang['SMTP_username_explain'] = 'Only enter a username if your SMTP server require_onces it';
$lang['SMTP_password'] = 'SMTP Password';
$lang['SMTP_password_explain'] = 'Only enter a password if your SMTP server require_onces it';
...
$lang['Visual_confirm_explain'] = 'require_onces users enter a code defined by an image when registering.';
...
$lang['Inst_Step_2'] = 'Your admin username has been created.  At this point your basic installation is complete. You will now be taken to a screen which will allow you to administer your new installation. Please be sure to check the General Configuration details and make any require_onced changes. Thank you for choosing phpBB 2.';
...
$lang['Install_No_PCRE'] = 'phpBB2 require_onces the Perl-Compatible Regular Expressions Module for PHP which your PHP configuration doesn\'t appear to support!';
