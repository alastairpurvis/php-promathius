...
$lang['Forum_Index'] = 'Forums';  // eg. sitename Forum Index, %s can be removed if you prefer
...
$lang['Click_return_cp'] = '%sReturn to the control panel%s';
...
// $lang['Req_playing_total'] = '%d Playing Promathius, ';
...
$lang['Edit_profile'] = 'Control Panel';
$lang['Search'] = 'Search';
...
$lang['Registered_user_total'] = 'Total Members <b>%d</b>'; // # registered users
$lang['Newest_user'] = 'Our newest member is <b>%s%s%s</b>'; // a href, username, /a 
...
$lang['Login'] = 'Log in';
$lang['Logout'] = 'Log out [ ' . $userdata[username] . ' ]';
...
$lang['Click_return_login1'] = '%sLog in%s';
$lang['Click_return_home'] = 'Click %sHere%s to return to the home 
page';
...
//
$lang['Viewing_user_profile'] = "%s's Profile"; // %s is username 
$lang['About_user'] = "About %s"; // %s is username

$lang['Preferences'] = 'Preferences';
$lang['Items_require_onced'] = 'Items marked with a * are require_onced unless stated otherwise.';
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Displays a small graphic image below your user name in posts. Only one image can be displayed at a time and the file size can be no greater than %d KB.';
...
$lang['Empire_deleted'] = 'Your empire has been abandoned';
$lang['Profile_updated_inactive'] = 'Your profile has been updated. However, you have changed vital details, thus your account is now inactive. Check your e-mail to find out how to reactivate your account, or if admin activation is require_onced, wait for the administrator to reactivate it.';

$lang['Password_mismatch'] = 'Mismatch.';
$lang['Current_password_mismatch'] = 'The current password you supplied does not match that stored in the database.';
$lang['Password_long'] = 'Too long';
$lang['Password_short'] = 'Too short.';
$lang['Cannot_reg'] = 'You cannot register while logged in to an account! Multiple accounts are not permitted.';
$lang['Username_taken'] = 'Already been taken';
$lang['Empire_taken'] = 'Sorry, but this empire name has already been taken.';
$lang['Empire_invalid'] = 'Sorry, but this empire name contains an invalid character such as \'.';
$lang['Username_invalid'] = 'Contains invalid character';
$lang['Username_disallowed'] = 'Sorry, but this username has been disallowed.';
$lang['Email_taken'] = 'Already registered';
$lang['Email_banned'] = 'Sorry, but this e-mail address has been banned.';
$lang['Email_invalid'] = 'Invalid.';
$lang['Signature_too_long'] = 'Your signature is too long.';
$lang['Fields_empty'] = 'You must fill in the require_onced fields.';
...
$lang['Account_inactive'] = 'Your account has been created. However, this forum require_onces account activation. An activation key has been sent to the e-mail address you provided. Please check your e-mail for further information';
$lang['Account_inactive_admin'] = 'Your account has been created. However, this forum require_onces account activation by the administrator. An e-mail has been sent to them and you will be informed when your account has been activated';
...
$lang['Reg_agreement'] = 'As a user of this software, you are permitted to one account only. If multiple accounts are found being used by a single user, you agree that the user can be liable for a permanent ban to this website. To play or post on the forums, you are only require_onced to create an account once. If your empire is destroyed or abandoned, you are not require_onced to sign up again to create a new one.<br /><br />While the administrators and moderators of the forums will attempt to remove or edit any generally objectionable material as quickly as possible, it is impossible to review every message. Therefore you acknowledge that all posts made to the forums express the views and opinions of the author and not the administrators, moderators or webmaster (except for posts by these people) and hence will not be held liable.<br /><br />You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-oriented or any other material that may violate any applicable laws. Doing so may lead to you being immediately and permanently banned (and your service provider being informed). The IP address of all posts is recorded to aid in enforcing these conditions. You agree that the webmaster, administrator and moderators of this website have the right to remove, edit, move or close any topic or account at any time should they see fit. As a user you agree to any information you have entered above being stored in a database. While this information will not be disclosed to any third party without your consent the webmaster, administrator and moderators cannot be held responsible for any hacking attempt that may lead to the data being compromised.<br /><br />This login system uses cookies to store information on your local computer. These cookies do not contain any of the information you have entered; they serve only to improve your viewing pleasure. The e-mail address is used only for confirming your registration details and password (and for sending new passwords should you forget your current one).<br /><br />By clicking Register below you agree to be bound by these conditions.';
...
$lang['Confirm_code_impaired'] = 'If you are visually impaired or cannot otherwise read the code below please contact the %sAdministrator%s for help.';
...
$lang['You_been_banned'] = 'You have been banned.<br />Please contact the webmaster or a moderator for more information.';
...
$lang['Playing_Promathius'] = 'Playing Promathius';
...
$lang['Establish_empire'] = 'Empire Founded';
$lang['Account_Created'] = 'Account Successfully Created';
