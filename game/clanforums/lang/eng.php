...
//In english
$l_poll_question='Question for your poll';
$l_poll_answer='Options *';
$l_poll_vote='Vote';
$l_poll_result='Results';
$l_poll_numberofvotes='Number of votes';
$l_poll_create='Create your own poll';
$l_poll_min2='Fill in a minimum of 2 potential answers, leave answers blank if you do not need them. <br />Suggestion: give your users a chance to have "No opinion"';
$l_poll_new='Create poll';
$l_poll='Polls';
$l_poll_desc='Vote and ask for others to vote to your question';
$l_poll_votes='Number of voters';
$l_poll_author='Poll posted by';
$l_poll_posted='Posted';
$l_poll_novotes='No votes entered yet...';
$l_enterpolls='Enter polls';
$l_poll_moreanswer='One more answer';
$l_areYouSureDeletePoll='Are you sure you want to delete this post? ( WITHOUT BACKUP ) ';
?>
