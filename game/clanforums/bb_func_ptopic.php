...
if (((isset($allForumsReg) and $allForumsReg) OR (sizeof($regUsrForums)>0 and in_array($forum,$regUsrForums))) and $user_id==0) {
...
require_once($game_root_path.'/clanforums/bb_func_pthread.php');
}
else {
