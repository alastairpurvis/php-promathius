...
<?
	$list = mysql_safe_query("SELECT num,name,tag FROM $clandb WHERE members>0,num != $uclan[num] ORDER BY num DESC;");
	while ($clan = mysql_fetch_array($list))
	{
?>
<option value="<?=$clan[num]?>"<?if ($clan[num] == $uclan[$item]) print " selected";?>><?=$clan[name]?></option>
<?
	}
?>
</select>
...
<tr>
<td align="center" class="shlarge" rowspan=2 style="padding-top:9px;padding-bottom:15px; padding-left: 12px; padding-right: 12px">
<table >
<tr><th align="center"><span class="cgood">Ally</span><br />Cannot attack</th></tr>
<tr><td style="text-align:center"><?listopt(ally1);?></td>
<tr><td style="text-align:center"><?listopt(ally2);?></td>
<tr><td style="text-align:center"><?listopt(ally3);?></td>
<tr><td style="text-align:center"><?listopt(ally4);?></td>
<tr><td style="text-align:center"><?listopt(ally5);?></td>
<tr><td>&nbsp;</td></tr></table></td><?=$shadowdata['end']?>
<table cellspacing="0" cellpadding="0">
<tr>
<td align="center" class="shlarge" rowspan=2 style="padding-top:9px;padding-bottom:15px; padding-left: 12px; padding-right: 12px">
<table>
<tr><th align="center"><span class="cbad">Enemy</span><br />Infinite attacks</th></tr>
<tr><td style="text-align:center"><?listopt(war1);?></td></tr>
<tr><td style="text-align:center"><?listopt(war2);?></td></tr>
<tr><td style="text-align:center"><?listopt(war3);?></td></tr>
<tr><td style="text-align:center"><?listopt(war4);?></td></tr>
<tr><td style="text-align:center"><?listopt(war5);?></td></tr>
</table><?=$shadowdata['end']?><table>
<tr><td colspan="2" class="acenter"><input type="submit" name="do_changerelations" class="mainoption" value="Change Relations"></td></tr></table>
<?
}
...
?>
<?if (($uclan[founder] == $users[num]) || ($uclan[asst] == $users[num])){?><span style="font-size: 10px"><span style="font-size: 10px"><a href="?clanmanage<?=$authstr?>">News</a> | <a href="?clanman_members<?=$authstr?>">Members</a> | <b>Relations</b> | <a href="?clanman_info<?=$authstr?>">Clan Info</a></span><br /><br /><?}?>

<form method="post" action="?clanman_relations<?=$authstr?>">
<div>
<?relations();?>
</div>
</form>
