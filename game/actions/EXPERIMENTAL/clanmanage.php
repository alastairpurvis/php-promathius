...
function motd()
{
	global $uclan;
?>
<b>Clan Message of the Day</b><br /> All members see on the their home page, <a href="forum/bbcode.php" target="_blank">BBCode</a> can be used.<br />
<textarea rows="6" cols="50" name="new_motd"><?=$uclan[motd]?></textarea><br /><br />
<b>Public News </b><br />(Viewable on clan profile)<br />
<textarea class="mainoption" rows="6" cols="50" name="new_crier"><?=$uclan[criernews]?></textarea><br />
<input type="submit" name="do_changemotd" value="Update News" class="mainoption">
<?
}
...
?>
<?if (($uclan[founder] == $users[num]) || ($uclan[asst] == $users[num])){?><span style="font-size: 10px"><b>News</b> | <a href="?clanman_members<?=$authstr?>">Members</a> | <a href="?clanman_relations<?=$authstr?>">Relations</a> | <a href="?clanman_info<?=$authstr?>">Clan Info</a></span><br />
<br /><?}?>
<br />
