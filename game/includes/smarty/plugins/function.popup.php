 ...
 * Type:     function<br />
 * Name:     popup<br />
 * Purpose:  make text pop up in windows via overgame/lib
...
function smarty_function_popup($params, &$smarty)
{
    ...
    if (empty($text) && !isset($inarray) && empty($function)) {
        $smarty->trigger_error("overgame/lib: attribute 'text' or 'inarray' or 'function' require_onced");
        return false;
    }

    if (empty($trigger)) { $trigger = "onmouseover"; }

    $retval = $trigger . '="return overgame/lib(\''.preg_replace(array("!'!","![\r\n]!"),array("\'",'\r'),$text).'\'';
