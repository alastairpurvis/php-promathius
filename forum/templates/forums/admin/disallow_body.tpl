...
<form method="post" action="{S_FORM_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr> 
		<th class="forum" class="thHead" colspan="2">{L_ADD_DISALLOW}</th>
	</tr>
	<tr> 
	...
	<tr> 
		<th class="forum" class="thHead" colspan="2">{L_DELETE_DISALLOW}</th>
	</tr>
	<tr> 
