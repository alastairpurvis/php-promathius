...
<form action="{S_RANK_ACTION}" method="post"><table class="forumline" cellpadding="4" cellspacing="1" align="center">
	<tr>
		<th class="forum" class="thTop" colspan="2">{L_RANKS_TITLE}</th>
	</tr>
	<tr>
