...
<p>{L_AUTH_EXPLAIN}</p>
  ...
  <table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr> 
	  <th class="forum" width="30%" class="thCornerL">{L_FORUM}</th>
	  <!-- BEGIN acltype -->
	  <th class="forum" class="thTop">{acltype.L_UG_ACL_TYPE}</th>
	  <!-- END acltype -->
	  <th class="forum" class="thCornerR">{L_MODERATOR_STATUS}</th>
	</tr>
	<!-- BEGIN forums -->
	<tr> 
