...
<form method="post" action="{S_RANKS_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		<th class="forum" class="thCornerL">{L_RANK}</th>
        <th class="forum" class="thTop">{L_RANK_MINIMUM}</th>
		<th class="forum" class="thTop">{L_SPECIAL_RANK}</th>
		<th class="forum" class="thTop">{L_EDIT}</th>
		<th class="forum" class="thCornerR">{L_DELETE}</th>
	</tr>
	<!-- BEGIN ranks -->
	<tr>
