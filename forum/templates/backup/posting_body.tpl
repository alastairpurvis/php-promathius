  ...
  <tr> 
	<td valign="top" align="left" width="100%"> 
	  <table height="40" cellspacing="2" cellpadding="2">
		<tr valign="middle"> 
		  <td><span class="gensmall">Compose&nbsp;</span></td>
		  ...
		  <tr> 
			<td valign="middle" align="center"> <br />
			  <table width="100" cellspacing="0" cellpadding="5">
				...
				<tr align="center"> 
				  <td colspan="{S_SMILIES_COLSPAN}"><span  class="nav"><a href="{PATH}{U_MORE_SMILIES}" onclick="window.open('{PATH}{U_MORE_SMILIES}', '_phpbbsmilies', 'HEIGHT=300,resizable=yes,scrollbars=yes,WIDTH=250');return false;" target="_phpbbsmilies" class="nav">{L_MORE_SMILIES}</a></span></td>
				</tr>
	...
	<tr> 
	  ...
	  <td class="row2"><span class="gen"> </span> 
		<table cellspacing="0" cellpadding="1">
		  ...
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="disable_html" {S_HTML_CHECKED} /></span></td>
			<td><span class="gen">{L_DISABLE_HTML}</span></td>
		  </tr>
		  <!-- END switch_html_checkbox -->
		  <!-- BEGIN switch_bbcode_checkbox -->
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="disable_bbcode" {S_BBCODE_CHECKED} /></span></td>
			<td><span class="gen">{L_DISABLE_BBCODE}</span></td>
		  </tr>
		  <!-- END switch_bbcode_checkbox -->
		  <!-- BEGIN switch_smilies_checkbox -->
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="disable_smilies" {S_SMILIES_CHECKED} /></span></td>
			<td><span class="gen">{L_DISABLE_SMILIES}</span></td>
		  </tr>
		  <!-- END switch_smilies_checkbox -->
		  <!-- BEGIN switch_signature_checkbox -->
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="attach_sig" {S_SIGNATURE_CHECKED} /></span></td>
			<td><span class="gen">{L_ATTACH_SIGNATURE}</span></td>
		  </tr>
		  <!-- END switch_signature_checkbox -->
		  <!-- BEGIN switch_notify_checkbox -->
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="notify" {S_NOTIFY_CHECKED} /></span></td>
			<td><span class="gen">{L_NOTIFY_ON_REPLY}</span></td>
		  </tr>
		  <!-- END switch_notify_checkbox -->
		  <!-- BEGIN switch_delete_checkbox -->
		  <tr> 
			<td width="20"><span class="cbstyled"><input type="checkbox" name="delete" /></span></td>
