...
<form action="{S_THEME_ACTION}" method="POST"><table width="99%" cellpadding="4" cellspacing="1" align="center" class="forumline">
	<tr>
	  <th class="forum" class="thHead" colspan="3">{L_THEME_SETTINGS}</th>
	</tr>
	<tr>
	...
	<tr>
		<th class="forum">{L_THEME_ELEMENT}</th>
		<th class="forum">{L_VALUE}</th>
		<th class="forum">{L_SIMPLE_NAME}</th>
	</tr>
	<tr>
