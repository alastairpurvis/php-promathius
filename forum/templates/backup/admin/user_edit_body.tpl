...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_REGISTRATION_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thSides" colspan="2">{L_PROFILE_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thSides" colspan="2">{L_PREFERENCES}</th>
	</tr>
	<tr> 
	...
	<tr>
	  <th class="forum" class="thSides" colspan="2">{L_SPECIAL}</th>
	</tr>
	<tr>
