...
<form method="post" name="post" action="{S_BANLIST_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_BAN_USER}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_UNBAN_USER}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_BAN_IP}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_UNBAN_IP}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_BAN_EMAIL}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="forum" class="thHead" colspan="2">{L_UNBAN_EMAIL}</th>
	</tr>
	<tr> 
