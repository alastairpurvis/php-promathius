...
// A link back to GamingHeadlines.co.uk would be appreciated!
	...
	function preloadImages()
		{
		img1 = new Image();img1.src = "../data/images/forums/CheckboxUnchecked.gif";
		img1 = new Image();img1.src = "../data/images/forums/CheckboxChecked.gif";
		
		img2 = new Image();img1.src = "../data/images/forums/RadioboxUnchecked.gif";
		img2 = new Image();img1.src = "../data/images/forums/RadioboxChecked.gif";
		}
