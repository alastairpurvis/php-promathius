...
<thead>
	...
	<tr>
		<td align="left" valign="bottom" width="25"><img src="../data/images/forums/hdr_left.gif" width="25" height="27" alt="" /></td>
		<td align="center" class="forumheader-mid">{L_REGISTRATION_INFO}</td>
		<td align="right" valign="bottom" width="25"><img src="../data/images/forums/hdr_right.gif" width="25" height="27" alt="" /></td>
	</tr></table></caption>
</thead>
<tbody>
	<tr> 
	...
	<!-- END switch_confirm -->
	<tr> 
	  <td class="spaceRow2" colspan="2"><img src="../data/images/forums/spacer.gif" width="1" height="2" alt="" /></td>
	</tr>
	<tr> 
	  <th class="forum" class="thSides" colspan="2" height="25" valign="middle">{L_PROFILE_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row2"> 
		<textarea name="signature" style="width: 98%" rows="7" cols="30" class="post">{SIGNATURE}</textarea>
	  </td>
	</tr>
	<tr> 
	  <td class="spaceRow2" colspan="2"><img src="../data/images/forums/spacer.gif" width="1" height="2" alt="" /></td>
	...
	<tr> 
	  <th class="forum" class="thSides" colspan="2" height="25" valign="middle">{L_PREFERENCES}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row2"><table cellspacing="0" cellpadding="1">
	  <tr>	
		<td width="20"><span class="rbstyled"><input type="radio" name="popup_pm" value="1" {POPUP_PM_YES} /></span></td>
		<td><span class="gen">{L_YES}&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
		<td width="20"><span class="rbstyled"><input type="radio" name="popup_pm" value="0" {POPUP_PM_NO} /></span></td>
		<td><span class="gen">{L_NO}</span></td>
	  </tr>
	  </table></td>
	</tr>
	...
	<tr> 
	  <th class="forum" class="thSides" colspan="2" height="12" valign="middle">{L_AVATAR_PANEL}</th>
	</tr>
	<tr> 
