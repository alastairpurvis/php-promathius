...
// www.phpBB-SEO.com SEO TOOLK	$topic_title = preg_replace($orig_word, $replacement_word, $topic_title);IT END
...
//
$sql = "SELECT u.username, u.user_id, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_sig, u.user_sig_bbcode_uid, u.user_avatar, u.user_avatar_type, u.user_allowavatar, u.user_allowsmile, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid, u.empire, u.is_empire, u.user_showempire
...
for($i = 0; $i < $total_posts; $i++)
{
	...
	$post_date = create_date($board_config['default_dateformat'], $postrow[$i]['post_time'], $board_config['board_timezone'], true);

	$poster_posts = ( $postrow[$i]['user_id'] != ANONYMOUS ) ? $lang['Posts'] . ': ' . $postrow[$i]['user_posts'] : '';
	$poster_empire = ( $postrow[$i]['user_id'] != ANONYMOUS && $postrow[$i]['is_empire'] != '0' && $postrow[$i]['user_showempire'] != 0) ? "<br />
				<b>Empire</b><br />" . $postrow[$i]['empire']."</i>" : '';
	
		$poster_clan = ( $postrow[$i]['user_id'] != ANONYMOUS && $userdata[is_empire] != '0' ) ? "Empire: " . $postrow[$i][clan]."</i>" : '';
	...
	$search_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_search'] . '" alt="' . sprintf($lang['Search_user_posts'], $postrow[$i]['username']) . '" title="' . sprintf($lang['Search_user_posts'], $postrow[$i]['username']) . '" /></a>';
