...
<table width="100%" cellpadding="4" cellspacing="1" class="forumline">
  <tr> 
	<th class="forum" width="25%" nowrap="nowrap" height="25" class="thCornerL">{L_STATISTIC}</th>
	<th class="forum" width="25%" height="25" class="thTop">{L_VALUE}</th>
	<th class="forum" width="25%" nowrap="nowrap" height="25" class="thTop">{L_STATISTIC}</th>
	<th class="forum" width="25%" height="25" class="thCornerR">{L_VALUE}</th>
  </tr>
  <tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" class="forumline">
  <tr> 
	<th class="forum" width="20%" class="thCornerL" height="25">&nbsp;{L_USERNAME}&nbsp;</th>
	<th class="forum" width="20%" height="25" class="thTop">&nbsp;{L_STARTED}&nbsp;</th>
	<th class="forum" width="20%" class="thTop">&nbsp;{L_LAST_UPDATE}&nbsp;</th>
	<th class="forum" width="20%" class="thCornerR">&nbsp;{L_FORUM_LOCATION}&nbsp;</th>
	<th class="forum" width="20%" height="25" class="thCornerR">&nbsp;{L_IP_ADDRESS}&nbsp;</th>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="5" height="1" class="row3"><img src="../templates/cs/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
