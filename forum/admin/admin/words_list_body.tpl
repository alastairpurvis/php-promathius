...
<form method="post" action="{S_WORDS_ACTION}"><table cellspacing="1" cellpadding="4" align="center" class="forumline">
	<tr>
		<th class="forum" class="thCornerL">{L_WORD}</th>
		<th class="forum" class="thTop">{L_REPLACEMENT}</th>
