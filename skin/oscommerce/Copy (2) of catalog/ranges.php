...
if(!$HTTP_GET_VARS['cPath'] || !$cat_infox['categories_name'])
{
...
?>
        ...
        <table cellpadding="0" cellspacing="0" width="761" height="288">
            <tr>
                ...
                <td valign="bottom" style="padding-right: 30px; padding-top: 10px;">
...
<? if($cat_info['categories_name'] != 'Cell CPR'){?>
                        <a href="<? echo $more_info_link ?>"><img src="images/buttons/seerange_o.jpg" onmouseover="this.src='images/buttons/seerange.jpg';" onmouseout="this.src='images/buttons/seerange_o.jpg';" border="0" /></a>
                        <? }else { ?>
                        <a href="<? echo $more_info_link ?>"><img src="images/buttons/buyonline_blue.gif" onmouseover="this.src='images/buttons/buyonline_grey.gif';" onmouseout="this.src='images/buttons/buyonline_blue.gif';" border="0" /></a>
                        <? } ?>
                        </td>
