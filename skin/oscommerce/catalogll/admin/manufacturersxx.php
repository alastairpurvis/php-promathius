<?php
/*
  $Id: manufacturers.php 6137 2005-05-10 12:59:09Z jim $
...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      $contents[] = array('text' => '<br>' . TEXT_MANUFACTURERS_IMAGE . '<br>' . tep_draw_input_field('manufacturers_image', '', '', '', 'file'));
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br>' . TEXT_MANUFACTURERS_IMAGE . '<br>' . tep_draw_input_field('manufacturers_image', $mInfo->manufacturers_image, '', '', 'file') . '<br>' . $mInfo->manufacturers_image);
