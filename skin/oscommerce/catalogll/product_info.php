...
<?php echo tep_image(DIR_WS_IMAGES . $product_info['large_products_image'], $product_info['products_name'], 'hspace="5" border="0" vspace="5"'); ?>
          ...
          <td valign="top"  style="padding-top:14px;"><table width="100%" cellspacing="0" cellpadding="0"><td><strong class="title"><?php echo $products_name; ?></strong></td><td align=right><a class="inactive" href="javascript:history.back(-1)">Back</a></td></table></td>
      </tr>
      <tr>
        <td  style="padding-top:14px;"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
        <td class="main">
<?php
...
?>
          <p style="text-align:justify;"><?php echo stripslashes($product_info['products_description']); ?></p>
<?php
