        ...
        <table cellpadding="0" cellspacing="0" width="192" align="right">
          ...
          <tr>
                 ...
                 <td class="rightNav" style="padding-left: 5px;">
                        <a href="<? ECHO tep_href_link(FILENAME_LIFESTYLE) ?>&page=SkinDiet" id="Right_1" class="<? if ($lspage == 1){ echo 'active';}else {echo 'inactive';}?>">Skin &amp; Diet</a><br />

                        <a href="<? ECHO tep_href_link(FILENAME_LIFESTYLE) ?>&page=NutritionTips" id="Right_2" class="<? if ($lspage == 2){ echo 'active';}else {echo 'inactive';}?>">Nutrition Tips</a><br />
                        <a href="<? ECHO tep_href_link(FILENAME_LIFESTYLE) ?>&page=LifestyleProgramme" id="Right_3" class="<? if ($lspage == 3){ echo 'active';}else {echo 'inactive';}?>">Lifestyle Programme</a><br />
                        <a href="<? ECHO tep_href_link(FILENAME_LIFESTYLE) ?>&page=CelluliteTherapy" id="Right_4" class="<? if ($lspage == 4){ echo 'active';}else {echo 'inactive';}?>">Cellulite Therapy</a>
                        <p>
                        <div>
