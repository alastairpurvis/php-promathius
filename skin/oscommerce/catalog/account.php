...
<!-- body_text //-->
    ...
    <table border="0" width="697" height="296" cellspacing="0" cellpadding="0" style="background-image: url('images/accountbg.jpg'); padding-left: 25px">
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" align="center" valign="top" width="130"><?php echo '<b>' . OVERVIEW_PREVIOUS_ORDERS . '</b><br>'?></td>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
<?php
