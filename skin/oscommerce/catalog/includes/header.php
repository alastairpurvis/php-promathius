...
<div class="image07"></div><div class="image08"></div><div class="image09"></div><div class="image10"></div><div class="subnav1"></div><div class="subnav2"></div><div class="subnav3"></div><div class="subnav4"></div><div class="subnav5"></div>
<div>
        ...
        <tr>
            ...
            <table cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td width="189"><img alt="Skin Nutrition" src="images/logo.gif" /></td>
                            <td width="23"><img src="images/pxl-trans.gif" width="23" height="1" /></td>

                            <td width="426" valign="bottom"><img alt="A technological revolution in skincare" src="images/tagline.gif" /></td>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 4px;"><a href="<?php echo tep_href_link(FILENAME_SHOPPING_CART); ?>"><img src="images/cart.jpg" border="0" /></a></td>
                                </tr>
                            </table>
                            </td>
                        </tr>
                ...
                <tr>
                    ...
                    <table cellspacing="0" cellpadding="0">
                        <tr>
                            <td><a class="noselect" href="<? ECHO tep_href_link(FILENAME_DEFAULT) ?>"><div style="width:130px; height:46px; background-image: url('images/nav/01.gif')" onmouseover="this.style.backgroundPosition = '0 -46px';" onmouseout="this.style.backgroundPosition = '0 0';" /></div></a></td>
                            <td><?if($page != 'about'){ ?><a class="noselect" href="<? ECHO tep_href_link(FILENAME_ABOUT); ?>"><? }?><div style="width:130px; height:46px; background-position: -130px <?if($page == 'about')echo '-92px'; else echo '0'?>; background-image: url('images/nav/01.gif')" <?if($page != 'about'){ ?>.jpg" onmouseover="this.style.backgroundPosition = '-130px -46px';" onmouseout="this.style.backgroundPosition = '-130px 0';" <? } ?>></div><?if($page != 'about') echo '</a>' ?></td>
                            <td><?if($page != 'ranges'){ ?><a class="noselect" href="<? ECHO tep_href_link(FILENAME_RANGES); ?>"><? }?><div style="width:130px; height:46px; background-position: -260px <?if($page == 'ranges')echo '-92px'; else echo '0'?>; background-image: url('images/nav/01.gif')" <?if($page != 'ranges'){ ?>.jpg" onmouseover="this.style.backgroundPosition = '-260px -46px';" onmouseout="this.style.backgroundPosition = '-260px 0';" <? } ?>></div><?if($page != 'ranges') echo '</a>' ?></td>
                            <td><?if($page != 'products'){ ?><a class="noselect" href="<?  $cPath_new = 'cPath=21'; ECHO tep_href_link(FILENAME_DEFAULT, $cPath_new) ?>"><? }?><div style="width:130px; height:46px; background-position: -390px <?if($page == 'products')echo '-92px'; else echo '0'?>; background-image: url('images/nav/01.gif')" <?if($page != 'products'){ ?>.jpg" onmouseover="this.style.backgroundPosition = '-390px -46px';" onmouseout="this.style.backgroundPosition = '-390px 0';" <? } ?>></div><?if($page != 'products') echo '</a>' ?></td>
                            <td><?if($page != 'news'){ ?><a class="noselect" href="<? ECHO tep_href_link(FILENAME_NEWS); ?>"><? }?><div style="width:130px; height:46px; background-position: -520px <?if($page == 'news')echo '-92px'; else echo '0'?>; background-image: url('images/nav/01.gif')" <?if($page != 'news'){ ?>.jpg" onmouseover="this.style.backgroundPosition = '-520px -46px';" onmouseout="this.style.backgroundPosition = '-520px 0';" <? } ?>></div><?if($page != 'news') echo '</a>' ?></td>
                            <td><?if($page != 'lifestyle'){ ?><a class="noselect" href="<? ECHO tep_href_link(FILENAME_LIFESTYLE); ?>"><? }?><div style="width:130px; height:46px; background-position: -650px <?if($page == 'lifestyle')echo '-92px'; else echo '0'?>; background-image: url('images/nav/01.gif')" <?if($page != 'lifestyle'){ ?>.jpg" onmouseover="this.style.backgroundPosition = '-650px -46px';" onmouseout="this.style.backgroundPosition = '-650px 0';" <? } ?>></div><?if($page != 'lifestyle') echo '</a>' ?></td>
