            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="182">
                    ...
                    <tr>
                        ...
                        <a href="<? ECHO tep_href_link(FILENAME_NEWS) ?>&page=news" class="<? if ($lspage == 1){ echo 'active';}else {echo 'inactive';}?>">News</a><br />
                        <a href="<? ECHO tep_href_link(FILENAME_NEWS) ?>&page=pressreleases" class="<? if ($lspage == 2){ echo 'active';}else {echo 'inactive';}?>">Press Releases</a><br />
                        <a href="<? ECHO tep_href_link(FILENAME_NEWS) ?>&page=pressclippings" class="<? if ($lspage == 3){ echo 'active';}else {echo 'inactive';}?>">Press Clippings</a><br />
                        </td>
                    </tr>
                </table>
